...
import com.wiser.animationlistdemo.BaseApp;
...
public class DeviceUtil {
    ...
    public static int getScreenWidth() {
        ...
        if (mScreenWidth == 0)
            mScreenWidth = BaseApp.Companion.getContext().getResources().getDisplayMetrics().widthPixels;
    ...
    public static int getScreenHeight() {
        ...
        if (mScreenHeight == 0)
            mScreenHeight = BaseApp.Companion.getContext().getResources().getDisplayMetrics().heightPixels;
