...
public class LoadToastView extends AppCompatImageView {
    ...
    public LoadToastView(Context context) {
        ...
        borderPaint.setStrokeWidth(borderOffset);
        ...
        completeicon = ContextCompat.getDrawable(context, R.drawable.ic_success);
        completeicon.setBounds(iconBounds);
        failedicon = ContextCompat.getDrawable(context, R.drawable.ic_error);
        failedicon.setBounds(iconBounds);

        va = ValueAnimator.ofFloat(0, 1);
        va.setDuration(6000);
        va.addUpdateListener(valueAnimator -> postInvalidate());
    ...
    private void initSpinner() {
        ...
        spinnerDrawable.setSizeParameters(mDiameter, mDiameter,
                (mDiameter - mProgressStokeWidth * 2) / 4f,
                mProgressStokeWidth,
